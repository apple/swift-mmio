...
public struct SVDDevice {
  ...
  ///
  /// Silicon vendors maintain the description throughout the life-cycle of the
  /// device and ensure that all updated and released copies have a unique
  ...
  /// order to avoid name clashes with other defined types.
  ...
  /// because it might be required to issue multiple accesses for resources of a
  /// bigger size. The expected value for Cortex-M-based devices is 32.
  public var width: UInt64
  /// Elements specify the default values for register size, access permission
  /// and reset value.
  ///
  /// These default values are inherited to all fields contained in this device.
  @XMLInlineElement
