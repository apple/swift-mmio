      ...
      Grid {
        ...
        ItemSectionView(
          ...
          lines: [
            ...
            ("Modified Write Values", (self.register.modifiedWriteValues ?? .modify).displayText),
            ("Write Constraint", "\(self.register.writeConstraint?.displayText ?? "No Constraint")"),
            ("Read Action", self.register.readAction?.rawValue ?? "No Side Effect"),
          ])
      }
    }
  }
