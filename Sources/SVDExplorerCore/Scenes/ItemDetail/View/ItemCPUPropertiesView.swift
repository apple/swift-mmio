...
struct ItemCPUPropertiesView: View {
  ...
  var body: some View {
    ItemSectionView(title: "CPU", lines: [
      ...
      ("Instruction Tightly Coupled Memory", self.model.itcmPresentDisplayText),
      ...
      ("Secure Attribution Unit Config", self.model.sauRegionsConfigDisplayText),
    ])
  }
}
