...
final class StringInterpolationBinaryTests: XCTestCase {
  @Test func appendInterpolation_binary() {
    ...
    // Int32
    XCTAssertEqual(
      "\(binary: Int32.min)", "0b1000_0000_0000_0000_0000_0000_0000_0000")
    XCTAssertEqual(
      "\(binary: Int32(-1))", "0b1111_1111_1111_1111_1111_1111_1111_1111")
    XCTAssertEqual(
      "\(binary: Int32(0))", "0b0000_0000_0000_0000_0000_0000_0000_0000")
    XCTAssertEqual(
      "\(binary: Int32(1))", "0b0000_0000_0000_0000_0000_0000_0000_0001")
    XCTAssertEqual(
      "\(binary: Int32.max)", "0b0111_1111_1111_1111_1111_1111_1111_1111")
    ...
    // UInt32
    XCTAssertEqual(
      "\(binary: UInt32.min)", "0b0000_0000_0000_0000_0000_0000_0000_0000")
    XCTAssertEqual(
      "\(binary: UInt32(1))", "0b0000_0000_0000_0000_0000_0000_0000_0001")
    XCTAssertEqual(
      "\(binary: UInt32.max)", "0b1111_1111_1111_1111_1111_1111_1111_1111")
