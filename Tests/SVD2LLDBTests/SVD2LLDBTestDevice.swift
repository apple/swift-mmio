...
private let fields: [SVDField] = [
  ...
  .init(
    ...
    enumeratedValues: .init(
      enumeratedValue: [
        .init(
          name: "KEEP", data: .value(.init(value: .init(value: 0, mask: mask)))),
        .init(
          name: "INCREMENT",
          data: .value(.init(value: .init(value: 1, mask: mask)))),
        .init(
          name: "DECREMENT",
          data: .value(.init(value: .init(value: 2, mask: mask)))),
      ])),
  .init(
    name: "RELOAD",
    ...
    enumeratedValues: .init(
      enumeratedValue: [
        ...
        .init(
          name: "RELOAD3",
          data: .value(.init(value: .init(value: 3, mask: mask)))),
      ])),
  .init(
    name: "TRGEXT",
    ...
    enumeratedValues: .init(
      enumeratedValue: [
        .init(
          name: "NONE", data: .value(.init(value: .init(value: 0, mask: mask)))),
        .init(
          name: "DMA1", data: .value(.init(value: .init(value: 1, mask: mask)))),
        .init(
          name: "DMA2", data: .value(.init(value: .init(value: 2, mask: mask)))),
        .init(
          name: "UART", data: .value(.init(value: .init(value: 3, mask: mask)))),
      ])),
  .init(
    name: "CAPEDGE",
    ...
    enumeratedValues: .init(
      enumeratedValue: [
        ...
        .init(
          ...
          data: .value(.init(value: .init(value: 1, mask: mask)))),
        .init(
          name: "BOTH", data: .value(.init(value: .init(value: 2, mask: mask)))),
      ])),
  .init(
    name: "CAPSRC",
    ...
    enumeratedValues: .init(
      enumeratedValue: [
        .init(
          name: "CClk", data: .value(.init(value: .init(value: 0, mask: mask)))),
        .init(
          name: "GPIOA_0",
          data: .value(.init(value: .init(value: 1, mask: mask)))),
        .init(
        ...
        .init(
          name: "GPIOA_3",
          data: .value(.init(value: .init(value: 4, mask: mask)))),
        .init(
          name: "GPIOA_4",
          data: .value(.init(value: .init(value: 5, mask: mask)))),
        .init(
          name: "GPIOA_5",
          data: .value(.init(value: .init(value: 6, mask: mask)))),
        .init(
          name: "GPIOA_6",
          data: .value(.init(value: .init(value: 7, mask: mask)))),
        .init(
          name: "GPIOA_7",
          data: .value(.init(value: .init(value: 8, mask: mask)))),
        .init(
          name: "GPIOB_0",
          data: .value(.init(value: .init(value: 9, mask: mask)))),
        .init(
          name: "GPIOB_1",
          data: .value(.init(value: .init(value: 10, mask: mask)))),
        .init(
          name: "GPIOB_2",
          data: .value(.init(value: .init(value: 11, mask: mask)))),
        .init(
          name: "GPIOB_3",
          data: .value(.init(value: .init(value: 12, mask: mask)))),
        .init(
          name: "GPIOC_0",
          data: .value(.init(value: .init(value: 13, mask: mask)))),
        .init(
          name: "GPIOC_5",
          data: .value(.init(value: .init(value: 14, mask: mask)))),
        .init(
          name: "GPIOC_6",
          data: .value(.init(value: .init(value: 15, mask: mask)))),
      ])),
  .init(
    name: "CNTSRC",
